# CLAUDE.md — petasum-super-petasum

**ORGAN IV** (Orchestration) · `organvm-iv-taxis/petasum-super-petasum`
**Status:** ACTIVE · **Branch:** `main`

## What This Repo Is

Organization-wide issue tracking with logic-first governance framework and conflict resolution
...
📁 tests/
  ...
  LICENSE
  LIFECYCLE_ROADMAP.md
  LOGIC_FRAMEWORK.md
  PRINCIPLE_CONFLICTS.md
  README.md
  SECURITY.md
  SETUP.md
  copilot-chat-response-transcript
  pyproject.toml
  seed.yaml
```
...
### Edges
- **Produces** → `unspecified`: governance-policy
- **Consumes** ← `META-ORGANVM`: registry

### Siblings in Orchestration
`orchestration-start-here`, `universal-node-network`, `.github`, `agentic-titan`, `agent--claude-smith`, `a-i--skills`, `tool-interaction-design`, `system-governance-framework`, `reverse-engine-recursive-run`, `collective-persona-operations`
...
Run: `organvm ecosystem show petasum-super-petasum` | `organvm ecosystem validate --organ IV`
...
Convergences: 20 | Run: `organvm network map --repo petasum-super-petasum` | `organvm network suggest`


## Entity Identity (Ontologia)

**UID:** `ent_repo_01KKKX3RVPWQZNVCAMWQ3W2JB9` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve petasum-super-petasum` | History: `organvm ontologia history ent_repo_01KKKX3RVPWQZNVCAMWQ3W2JB9`
